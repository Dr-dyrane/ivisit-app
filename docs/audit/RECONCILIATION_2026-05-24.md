...
|---|---|---|
| `audit/demo/DEMO_BOOTSTRAP_DUPLICATE_HOSPITAL_BUG_2026-05-10.md` | ⚠ï¸ Mostly closed | Pass 4 (client coverage gate) shipped; Passes 1, 2, 3, 5-SQL still PLANNED per `audit/demo/README.md`. Relocated 2026-05-24 from `audit/` root to `audit/demo/`. Carryforward: server-side passes |
