...
**Scope**: Wide — tracking → visit detail handoff Â· rating modal chain Â· re-booking entry Â· visit stack pages  
...
**Guide**: `TRACKING_SHEET_LEARNINGS.md` defect classes 2.1–2.14 Â· `PRE_TRACKING_PHASE_AUDIT_2026-04-27_FINAL.md` constraint list.
