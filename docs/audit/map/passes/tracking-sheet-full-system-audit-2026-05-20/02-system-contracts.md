...
| Reload/rehydrate parity      | Trip store, visual atoms, rating atoms, and XState hydrate on different clocks.                                                                | Mapped; still needs cold-start proof for pending, active, arrived, completed/rating, and new-request swap.   |
