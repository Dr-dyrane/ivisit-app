...
| [Pass 4](./PASS_4_CLIENT_COVERAGE_GATE.md) | Frontend | Coverage Gate Owner Scoping | Low — standalone safety gate | PLANNED |
| [Pass 5](./PASS_5_DOC_UPDATE_AND_SQL_MIGRATION.md) | Docs / Post-Deploy | Documentation Update + SQL Migration | **High** — same commit as Pass 1+2 | PLANNED |
...
## Acceptance Checks (from DEMO_MODE_COVERAGE_FLOW.md §21–22)
