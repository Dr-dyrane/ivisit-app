...
- **Interactive Maps**: Route visualization, hospital markers, zoom optimization
...
iVisit maintains strict code quality and documentation standards across all repositories.

### **System Rules (Primary Authority)**

- **[docs/rules.json](./docs/rules.json)** - Locked v2.0 system rules, product doctrine, and architectural principles
  - Product truth, copy system, and human interface guidelines
  - Cross-surface alignment and responsive strategy
  - Engineering standards and release gates
  - **Rule:** When in doubt, `rules.json` wins.

### **Code Standards**

- **[.agent/workflows/code-standards.md](./.agent/workflows/code-standards.md)** - Development patterns and anti-surprise rules
  - Named exports only (no default exports)
  - Barrel imports for cleaner code
  - Naming consistency requirements
  - 6-step Deep Audit & Certification Protocol

### **Documentation Standards**

- **[docs/README.md](./docs/README.md)** - Documentation model and routing rules
  - Role-Based Doctrine Tree (11 folder roles)
  - Authority order for resolving conflicts
  - Archival procedures for superseded docs

- **[docs/INDEX.md](./docs/INDEX.md)** - Master navigation and current state tracking
  - Active vs. archived document locations
  - Current sprint checkpoints
  - Cross-reference hub
...
| Development | `develop` | Integration/QA |
| Features | `feat/*` | `develop` |
| Hotfixes | `fix/*` | `main` |
...
- **File Size Limits:**
  - Route/Layout: 20-100 lines (max 150)
  - Screen files: 250-400 lines (max 500)
  - UI Components: 80-250 lines (max 350)
  - Hooks: 80-200 lines (max 300)
  - >800 lines = mandatory refactor
  - >1000 lines = architectural violation

- **Line Limit Exceptions:**
  - Generated files
  - Test files with large datasets
