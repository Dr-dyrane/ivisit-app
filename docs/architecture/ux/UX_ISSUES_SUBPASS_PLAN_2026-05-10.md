...
**Status:** ðŸ”µ Deferred — LocationSheet must be stable first
...
|---|---|---|---|
| `MapBedDecisionStageParts.jsx` | 899 | max 450 (Complex Feature Component) | ðŸš¨ Exceeds — flag responsibility leakage |
...
| `MapBedDecisionStageBase.jsx` | 467 | max 500 (Screen file) | ⚠ï¸ Near limit |
