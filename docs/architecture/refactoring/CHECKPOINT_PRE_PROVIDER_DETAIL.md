...
- `useMapSheetPhaseReducer.js` — Valid transitions: EXPLORE_INTENTâ†”PROVIDER_LISTâ†”PROVIDER_DETAIL
...
- `MapCareHistoryModal.jsx` — 2Ã—2 blade grid, expand-modal chevron, two subtaxonomy rails (Direct / Specialist)
