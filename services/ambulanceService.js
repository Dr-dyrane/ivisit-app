...
const mapFromDb = (row) => {
    ...
    return {
        ...
        status: row.status,
        location,
        heading: Number.isFinite(row.heading) ? row.heading : null,
        locationAccuracyMeters: row.location_accuracy_meters ?? null,
        locationObservedAt: row.location_observed_at ?? null,
        locationReceivedAt: row.location_received_at ?? null,
        telemetrySequence: row.telemetry_sequence ?? null,
        telemetryLeaseExpiresAt: row.telemetry_lease_expires_at ?? null,
        eta: row.eta,
        crew: row.crew,
