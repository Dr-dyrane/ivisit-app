...
const UI_SURFACES = [
  ...
  },
  {
    ...
    modal: 'src/services/trendingTopicsService.js',
    page: 'src/services/trendingTopicsService.js',
    service: 'src/services/trendingTopicsService.js',
    createFn: 'createTrendingTopic',
    updateFn: 'updateTrendingTopic',
    skipModalFieldExtraction: true,
    skipPageWiring: true,
    dynamicCreatePayload: true,
    dynamicUpdatePayload: true,
  },
  {
    id: 'notifications',
    table: 'notifications',
    modal: 'src/services/notificationService.js',
    page: 'src/services/notificationService.js',
    service: 'src/services/notificationService.js',
    createFn: 'createNotification',
    updateFn: 'markNotificationAsRead',
    preferConsoleTypes: true,
    skipModalFieldExtraction: true,
    skipPageWiring: true,
    dynamicCreatePayload: true,
  ...
  },
  {
    id: 'preferences',
    table: 'preferences',
    modal: 'src/services/preferencesService.js',
    page: 'src/services/preferencesService.js',
    service: 'src/services/preferencesService.js',
    createFn: 'createUserPreferences',
    updateFn: 'updateUserPreferences',
    skipModalFieldExtraction: true,
    skipPageWiring: true,
    dynamicCreatePayload: true,
    dynamicUpdatePayload: true,
  },
  {
    id: 'user_activity',
    table: 'user_activity',
    modal: 'src/services/activityService.js',
    page: 'src/services/activityService.js',
    service: 'src/services/activityService.js',
    createFn: 'logActivity',
    updateFn: 'getUserActivity',
    readOnlySurface: true,
    skipModalFieldExtraction: true,
    skipPageWiring: true,
    dynamicCreatePayload: true,
