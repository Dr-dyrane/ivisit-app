...
// BookBedRequestScreen is superseded by MapSheetOrchestrator bed decision flow.
...
export const DEPRECATED_FILE = "BookBedRequestScreen — Phase 7a — use MapSheetOrchestrator bed decision flow";
