...
export default function EmergencyScreen() {
  ...
  const handleEmergencyCall = (hospitalId) => {
    ...
    // TODO: Integrate with real emergency service API
  ...
  const filteredHospitals = HOSPITALS.filter((hospital) => hospital.type.toLowerCase() === serviceType)
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        >
          ...
          <View style={{ marginTop: 24 }}>
            <ServiceTypeSelector selectedType={serviceType} onSelect={handleServiceTypeSelect} />
          </View>
          ...
          <View style={{ marginTop: 32 }}>
            ...
            >
              ...
              <Text style={{ fontSize: 13, color: colors.textMuted }}>{filteredHospitals.length} nearby</Text>
            </View>
