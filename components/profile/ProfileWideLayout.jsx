...
import {
  computeProfileHeaderClearance,
  computeProfileThirdColumnLayout,
  getProfileSidebarGlassTokens,
  PROFILE_SIDEBAR_HIG,
} from "./profileSidebarLayout";
import ProfileIdentityPane from "./ProfileIdentityPane";
import ProfileContextPane from "./ProfileContextPane";
import ProfileActionIsland from "./ProfileActionIsland";
import ProfileActionList from "./surfaces/ProfileActionList";

// PULLBACK NOTE: Profile wide-screen variant follows the payment/emergency stack pattern.
// Left island owns identity/context, center owns the action list, XL right island fills the dead space with quick status/actions.

export default function ProfileWideLayout({
  isDarkMode,
  theme,
  metrics,
  layout,
  ...
  const glass = useMemo(
    () => getProfileSidebarGlassTokens({ isDarkMode }),
    [isDarkMode],
  );
    ...
    <>
      ...
      >
        ...
        <View style={{ flexDirection: "column", gap: 1 }}>
          ...
          >
            {PROFILE_SCREEN_COPY.screen.title}
          </Text>
        </View>
      </View>
      ...
      <BlurView
        ...
        style={{
          ...
          borderRadius: PROFILE_SIDEBAR_HIG.SIDEBAR_CORNER_RADIUS,
      ...
      >
        ...
        >
          ...
          <ProfileContextPane
            ...
            metrics={metrics}
            isDarkMode={isDarkMode}
            profileCompletionLabel={model.profileCompletionLabel}
      ...
      >
        <View style={{ gap: metrics.spacing.xs }}>
          ...
          >
            {PROFILE_SCREEN_COPY.center.title}
          </Text>
        </View>
        ...
        >
          ...
          >
            <ProfileActionIsland
              ...
              emergencyCountLabel={model.emergencyCountLabel}
              healthStatusLabel={model.healthStatusLabel}
              coverageStatusLabel={model.coverageStatusLabel}
              onEditPersonalInfo={model.openPersonalInfo}
