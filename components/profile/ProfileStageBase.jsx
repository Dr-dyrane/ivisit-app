...
import { createProfileScreenTheme } from "./profileScreen.theme";
import { computeProfileSidebarLayout } from "./profileSidebarLayout";

// PULLBACK NOTE: ProfileStageBase now owns shell, motion, and viewport branching.
// OLD: ProfileScreen kept the gradient, scroll shell, and animation boot inline.
// NEW: Route consumers only provide content; StageBase decides compact scroll vs MD+ sidebar shell.

export default function ProfileStageBase({ isDarkMode, children }) {
  ...
  const theme = useMemo(
    () => createProfileScreenTheme({ isDarkMode }),
    [isDarkMode],
  );
