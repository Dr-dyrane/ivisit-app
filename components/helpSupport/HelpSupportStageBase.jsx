...
import { computeHelpSupportSidebarLayout } from "./helpSupportSidebarLayout";
import { createHelpSupportScreenTheme } from "./helpSupport.theme";

export default function HelpSupportStageBase({
  isDarkMode,
  children,
  refreshControl = null,
}) {
  ...
  const theme = useMemo(
    () => createHelpSupportScreenTheme({ isDarkMode }),
    [isDarkMode],
  );
