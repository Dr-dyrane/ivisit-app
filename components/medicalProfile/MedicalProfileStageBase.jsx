...
import { createMedicalProfileScreenTheme } from "./medicalProfileScreen.theme";
import { computeMedicalProfileSidebarLayout } from "./medicalProfileSidebarLayout";

// PULLBACK NOTE: MedicalProfileStageBase owns shell, motion, and viewport branching.
// The route and orchestrator stay focused on behavior, composition, and modal ownership.

export default function MedicalProfileStageBase({ isDarkMode, children }) {
  ...
  const theme = useMemo(
    () => createMedicalProfileScreenTheme({ isDarkMode }),
    [isDarkMode],
  );
