...
// It provides status, last-updated truth, and the primary edit action without repeating long explanatory copy.

export default function MedicalProfileContextPane({
  theme,
  metrics,
  completionLabel,
  lastUpdatedLabel,
  ...
  return (
    ...
    >
      <View style={{ gap: metrics.spacing.xs }}>
        ...
        >
          {MEDICAL_PROFILE_SCREEN_COPY.context.title}
        </Text>
        {!compact ? (
          <Text
            style={{
          ...
          >
            {MEDICAL_PROFILE_SCREEN_COPY.context.body}
          </Text>
        ) : null}
      </View>
      ...
      >
        ...
        />
        <StatusRow
          label={MEDICAL_PROFILE_SCREEN_COPY.context.lastUpdatedLabel}
