...
import { createSearchScreenTheme } from "./searchScreen.theme";
import { computeSearchSidebarLayout } from "./searchSidebarLayout";

// PULLBACK NOTE: SearchStageBase mirrors the refined stack shell contract.
// It owns viewport-aware shell geometry, motion, and scroll plumbing so the
// orchestrator can stay focused on header wiring and composition choice.

export default function SearchStageBase({
  isDarkMode,
  children,
  refreshControl = null,
}) {
  ...
  const theme = useMemo(
    () => createSearchScreenTheme({ isDarkMode }),
    [isDarkMode],
  );
