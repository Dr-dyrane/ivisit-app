...
import { createInsuranceScreenTheme } from "./insuranceScreen.theme";
import { computeInsuranceSidebarLayout } from "./insuranceSidebarLayout";

// PULLBACK NOTE: InsuranceStageBase owns shell, motion, and viewport branching.
// The route and orchestrator stay focused on behavior, composition, and modal ownership.

export default function InsuranceStageBase({
  isDarkMode,
  children,
  refreshControl = null,
}) {
  ...
  const theme = useMemo(
    () => createInsuranceScreenTheme({ isDarkMode }),
    [isDarkMode],
  );
