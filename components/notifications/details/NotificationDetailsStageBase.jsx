...
import { createNotificationDetailsTheme } from "./notificationDetails.theme";

export default function NotificationDetailsStageBase({
  isDarkMode,
  children,
}) {
  ...
  const theme = useMemo(
    () => createNotificationDetailsTheme({ isDarkMode }),
    [isDarkMode],
  );
