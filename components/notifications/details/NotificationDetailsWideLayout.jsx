...
import NotificationDetailsActionIsland from "./NotificationDetailsActionIsland";
import NotificationDetailsContextPane from "./NotificationDetailsContextPane";
...
export default function NotificationDetailsWideLayout({
  isDarkMode,
  theme,
  metrics,
  layout,
    ...
    <>
      ...
      >
        ...
        <View style={{ flexDirection: "column", gap: 1 }}>
          ...
          >
            {NOTIFICATION_DETAILS_COPY.screen.title}
          </Text>
        </View>
      </View>
      ...
      >
        ...
        >
          <NotificationDetailsContextPane
            theme={theme}
            metrics={metrics}
            model={model}
          />
      ...
      >
        ...
        >
          {NOTIFICATION_DETAILS_COPY.center.title}
        </Text>
      ...
      {showThirdColumn ? (
        ...
        >
          <ScrollView
            ...
            showsVerticalScrollIndicator={false}
          >
            <NotificationDetailsActionIsland
              theme={theme}
              metrics={metrics}
              model={model}
            />
