...
import { createSettingsScreenTheme } from "./settingsScreen.theme";
import { computeSettingsSidebarLayout } from "./settingsSidebarLayout";

// PULLBACK NOTE: SettingsStageBase owns shell, motion, and viewport branching.
// The settings route and orchestrator stay focused on behavior and composition.

export default function SettingsStageBase({ isDarkMode, children }) {
  ...
  const theme = useMemo(
    () => createSettingsScreenTheme({ isDarkMode }),
    [isDarkMode],
  );
