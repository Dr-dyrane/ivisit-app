    ...
    >
      ...
      <View style={[styles.summaryCard, { backgroundColor: colors.cardBg }]}>
        <View style={styles.summaryHeader}>
          ...
          >
            <Ionicons
              name={bookingData.type === "telehealth" ? "videocam" : "medical"}
              size={26}
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text
              style={[styles.summarySpecialty, { color: colors.textMuted }]}
            >
          ...
          {costLabel ? (
            <View style={styles.summaryRow}>
              ...
              <View>
                ...
                <Text style={[styles.summaryValue, { color: colors.text }]}>
                  {quoteLoading ? "Loading estimate" : costLabel}
                </Text>
              </View>
            </View>
          ) : null}
