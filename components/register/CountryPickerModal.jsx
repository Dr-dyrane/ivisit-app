...
export default function CountryPickerModal({ visible, onClose, onSelect }) {
  ...
  const filtered = useMemo(() => {
    ...
    return countries.filter((c) => {
      ...
      const dialMatch = c.dial_code.replace(/\s/g, "").includes(q.replace(/\s/g, ""))
      ...
      <View className="flex-1 justify-end">
        ...
        >
          ...
          <View className="flex-row items-center justify-between mb-4">
            ...
            <Pressable onPress={handleClose} className="p-2 bg-gray-500/10 rounded-full">
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                <Text className="font-black text-base ml-2" style={{ color: colors.primary }}>
                  {item.dial_code}
                </Text>
              </Pressable>
            )}
            ListEmptyComponent={
              <View className="items-center py-8">
                ...
                <Text className="mt-4 text-sm font-medium" style={{ color: "#666" }}>
                  No countries found
                </Text>
              </View>
            }
