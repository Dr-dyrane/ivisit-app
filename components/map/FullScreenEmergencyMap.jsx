...
import { View, Text, StyleSheet, Alert, ActivityIndicator, Pressable, Animated } from "react-native";
...
const generateNearbyHospitals = (userLat, userLng, count = 6) => {
	...
	for (let i = 0; i < count; i++) {
		...
		const distance = Math.sqrt(latOffset * latOffset + lngOffset * lngOffset) * 111;
					...
					return (
						...
						>
							<PulsingMarker isSelected={isSelected}>
								<View style={[styles.hospitalMarker, isSelected && styles.hospitalMarkerSelected]}>
									<Ionicons
										name="add"
...
const darkMapStyle = [
	...
	{ featureType: "poi.medical", stylers: [{ visibility: "on" }] },
	{ featureType: "poi.medical", elementType: "geometry", stylers: [{ color: "#450A0A" }] },
	{ featureType: "poi.medical", elementType: "labels.text.fill", stylers: [{ color: "#F87171" }] },
	{ featureType: "poi.medical", elementType: "labels.icon", stylers: [{ visibility: "on" }] },

	// Show buildings
	{ featureType: "landscape.man_made", stylers: [{ visibility: "on" }] },
	{ featureType: "landscape.man_made", elementType: "geometry.fill", stylers: [{ color: "#1E293B" }] },
	...
	{ featureType: "road", elementType: "labels.text.fill", stylers: [{ color: "#64748B" }] },
	{ featureType: "road.highway", elementType: "geometry.fill", stylers: [{ color: "#422006" }] },
