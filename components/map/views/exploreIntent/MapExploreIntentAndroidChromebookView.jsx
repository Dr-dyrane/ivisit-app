...
export default function MapExploreIntentAndroidChromebookView(props) {
	return (
		<MapExploreIntentStageBase
			{...props}
			variant={MAP_INTENT_VARIANTS.ANDROID_CHROMEBOOK}
			screenConfig={getMapExploreIntentScreenConfig(MAP_INTENT_VARIANTS.ANDROID_CHROMEBOOK)}
		/>
	);
}
