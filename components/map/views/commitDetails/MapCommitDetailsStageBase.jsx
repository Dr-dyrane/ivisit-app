...
export default function MapCommitDetailsStageBase({
  ...
  // Commit details is always EXPANDED. Normalize here so both
  // useMapSheetDetents and MapSheetShell stay in sync regardless
  // of what the parent store emits during a transition frame.
  ...
  const headerSubtitle = useMemo(() => {
    ...
    // Surface care mode so the subtitle doesn't imply ambulance-only
    // when the user is confirming a bed booking or combined request.
    const careLabel =
      careIntent === "bed"
        ? "Bed booking"
        : careIntent === "both"
