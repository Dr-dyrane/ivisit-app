...
export function useEmergencyLocationSync() {
  ...
  useEffect(() => {
    ...
    if (globalLocationSource !== "device") return;
    ...
    setUserLocation(
      {
        ...
        longitude,
        latitudeDelta:
          Number(current?.latitudeDelta) || DEFAULT_APP_REGION.latitudeDelta,
        longitudeDelta:
          Number(current?.longitudeDelta) || DEFAULT_APP_REGION.longitudeDelta,
      },
      "device",
    );
  }, [
